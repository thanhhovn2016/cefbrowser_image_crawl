...
namespace CefSharp.Example.Handlers
{
    ...
    public class ExampleRequestHandler : RequestHandler
    {
        ...
        {
            if (request.Url.ToLower().EndsWith(".png") || request.Url.ToLower().EndsWith(".jpg") || request.Url.ToLower().EndsWith(".gif") || request.Url.ToLower().EndsWith(".svg")){
                Debug.WriteLine("Debug Get resource{0}", request.Url.ToLower());
